def _destag_single_var(datavar,
    ...
    # option 3) guess the staggered dimension
    else:
    ...
    center_mean           = (left_or_bottom_cells+right_or_top_cells)*.5
    ...
    if not unstag_dim_name:
        unstag_dim_name = stagger_dim.split("_stag")[0] # get the part of the name before the "_stag"
